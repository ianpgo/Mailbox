...
1. Can I implement an "Edit Changed" observer function that applies to both text fields and text views?
2. How do I implement segmented control with different view controllers?

### Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/HCJda1c.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
